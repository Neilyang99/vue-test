<template>
  <div class="app-container">
    <div class="block">
      ...
      <el-row>
        <el-col :span="24">
          <h3  style="border-bottom: 1px solid black;" justify="center" align="middle">退 戶 明 細 表</h3>
        </el-col>
      </el-row>
      <br>
      <el-row>
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row @current-change="handleCurrentChange">
      ...
      <el-table-column label="總金額(萬)">
        <template slot-scope="scope">
          {{scope.row.slb13006/10000}}
        </template>
      </el-table-column>
      <el-table-column label="退還金額(萬)">
        <template slot-scope="scope">
          {{scope.row.slb13007/10000}}
        </template>
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="8">
            <el-form-item label="棟別"  >
                <el-select  v-model="form.slb13004" placeholder="請選擇" >
                  <el-option
                    v-for="item in slb13004List"
                    :key="item.key"
                    :label="item.value"
                    :value="item.key">
                  </el-option>
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="總金額" prop="slb13006" >
              <el-input v-model="form.slb13006" maxlength="10" style="width:120px"></el-input>萬
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="退還金額" prop="slb13007" >
              <el-input v-model="form.slb13007" maxlength="10" style="width:100px"></el-input>萬
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="備註" prop="slb13008" >
              <el-input v-model="form.slb13008" maxlength="200"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
