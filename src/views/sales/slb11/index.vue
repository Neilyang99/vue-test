<template>
  <div class="app-container">
    <div class="block">
      ...
      <el-row>
        <el-col :span="24">
          <h3  style="border-bottom: 1px solid black;" justify="center" align="middle">成 交 明 細 表</h3>
        </el-col>
      </el-row>
      <br>
      <el-row>
    ...
    <el-table :data="list" v-loading="listLoading" element-loading-text="Loading" border fit highlight-current-row @current-change="handleCurrentChange">
      ...
      <el-table-column label="總金額(萬)">
        <template slot-scope="scope">
          {{scope.row.slb11006/10000}}
        </template>
      </el-table-column>
      <el-table-column label="訂金(萬)">
        <template slot-scope="scope">
          {{scope.row.slb11007/10000}}
        </template>
      </el-table-column>
    ...
    <el-dialog
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          <el-col :span="8">
            <el-form-item label="棟別"  >
                <el-select  v-model="form.slb11004" placeholder="請選擇" >
                  <el-option
        ...
        <el-row>
          <el-col :span="8">
            <el-form-item label="總金額" prop="slb11006" >
              <el-input v-model="form.slb11006" maxlength="10" style="width:120px"></el-input>萬
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="訂金" prop="slb11007" >
              <el-input v-model="form.slb11007" maxlength="10" style="width:100px"></el-input>萬
            </el-form-item>
          </el-col>
        ...
        <el-row>
          <el-col :span="24">
            <el-form-item label="備註" prop="slb11008" >
              <el-input v-model="form.slb11008" maxlength="200"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
